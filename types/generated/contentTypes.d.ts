...
export interface ApiContactInfoContactInfo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    feedbackEmail: Schema.Attribute.Email & Schema.Attribute.Required;
    legalEmail: Schema.Attribute.Email & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    privacyEmail: Schema.Attribute.Email & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHeroContentHeroContent extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    socialProofText: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiMetricMetric extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    feedback: Schema.Attribute.Integer & Schema.Attribute.Required;
    interviews: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::metric.metric'
    > &
      Schema.Attribute.Private;
    pageViews: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    signups: Schema.Attribute.Integer & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiWeeklyUpdateWeeklyUpdate
  extends Struct.CollectionTypeSchema {
  collectionName: 'weekly_updates';
  info: {
    displayName: 'Weekly Update';
    pluralName: 'weekly-updates';
    singularName: 'weekly-update';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    feedback: Schema.Attribute.Integer;
    interviews: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::weekly-update.weekly-update'
    > &
      Schema.Attribute.Private;
    nextWeek: Schema.Attribute.JSON;
    pageViews: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    signups: Schema.Attribute.Integer;
    statusWeek: Schema.Attribute.Enumeration<['current', 'completed']> &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::weekly-update.weekly-update': ApiWeeklyUpdateWeeklyUpdate;
